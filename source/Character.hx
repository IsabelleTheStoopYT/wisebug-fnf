	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'parents-christmas':
				...
				playAnim('idle');
			case 'buggy':
				tex = Paths.getSparrowAtlas('buckBumble/buggy_assets');
				frames = tex;
				animation.addByPrefix('idle', 'buggy_idle', 17);
				animation.addByPrefix('singUP', 'buggy_up', 17);
				animation.addByPrefix('singRIGHT', 'buggy_right', 17);
				animation.addByPrefix('singDOWN', 'buggy_down', 17);
				animation.addByPrefix('singLEFT', 'buggy_left', 17);

				addOffset('idle', 15, -15);
				...
				playAnim('idle');
			case 'cockoon':
				tex = Paths.getSparrowAtlas('buckBumble/bruh');
				frames = tex;
				animation.addByPrefix('idle', "COCOON_IDLE_UWU", 24, false);
				animation.addByPrefix('singUP', "COCOON_UP_UWU", 24, false);
				animation.addByPrefix('singRIGHT', "COCOON_RIGHT_UWU", 24, false);
				animation.addByPrefix('singLEFT', "COCOON_LEFT_UWU", 24, false);
				animation.addByPrefix('singDOWN', "COCOON_DOWN_UWU", 24, false);

				addOffset('idle', 0, 20);
				addOffset('singUP', 0, 50);
				addOffset("singRIGHT", 0, 30);
				addOffset("singLEFT", 48, 25);
