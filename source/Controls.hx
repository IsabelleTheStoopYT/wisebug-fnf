...
class Controls extends FlxActionSet
{
	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		{
			case Solo:
				inline bindKeys(Control.UP, [J, FlxKey.NUMPADTWO]);
				inline bindKeys(Control.DOWN, [F, X]);
				inline bindKeys(Control.LEFT, [D, Z]);
				inline bindKeys(Control.RIGHT, [K, FlxKey.NUMPADTHREE]);
